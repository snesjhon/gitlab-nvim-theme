...
function theme.loadEditor(c)
  util.loadColorSet({
    ...
    DiffText       = { fg = c.orange,     bg = c.diff_text_bg, style = "bold" },
...
function theme.loadLSP(c)
  util.loadColorSet({
    ...
    DiagnosticVirtualTextError   = { fg = c.red,    bg = c.vt_error_bg, style = c.italic },
    DiagnosticVirtualTextWarn    = { fg = c.orange, bg = c.vt_warn_bg,  style = c.italic },
    DiagnosticVirtualTextInfo    = { fg = c.blue,   bg = c.vt_info_bg,  style = c.italic },
    DiagnosticVirtualTextHint    = { fg = c.green,  bg = c.vt_hint_bg,  style = c.italic },
...
function theme.loadPlugins(c)
  util.loadColorSet({
    ...
    NeogitDiffAdd             = { fg = c.green, bg = c.diff_add_bg },
    NeogitDiffDelete          = { fg = c.red,   bg = c.diff_delete_bg },
    ...
    DapStopped             = { fg = c.green, bg = c.dap_stop_bg },
    DapStoppedLine         = { bg = c.dap_stop_bg },
